						...
						<div class="card">
							...
							<div class="card-body">
								<div class="horizontal-form-elements">
									<form class="form-horizontal" action="{{ route('kategori-film.store') }}" method="POST">
										@csrf
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group @error('nama_kategori_film') has-error @enderror">
													...
													<div class="col-sm-6">
														<input required="required" name="nama_kategori_film" id="nama_kategori_film" type="text" class="form-control" placeholder="Nama Kategori Film" value="{{ old('nama_kategori_film') }}">
