                ...
                <div class="col-md-7">
                    <div class="friend-list">
                        <div class="row">
                                ...
                                <div class="friend-card">
                                    ...
                                    <div class="card-info">
                                        ...
                                        <div class="friend-info">
                                            <a href="{{ route('tolak-pertemanan', [$p->member_id]) }}" class="pull-right text-green">Tolak</a>
                                            <a href="{{ route('terima-pertemanan', [$p->member_id]) }}" class="pull-right text-green">Terima</a>
                                            <h5><a href="#" class="profile-link">{{ $p->member->nama }}</a></h5>
                                            <p>{{ $p->member->kota_lahir }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            @empty
                            <div class="col-md-12">
                                <div class="alert alert-danger">Tidak ada permintaan pertemanan</div>
                            </div>
                            @endforelse
                        </div>
                    </div>
